    ...
    <div id="page-infinite-scroll-bottom" class="page">
        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    <li sortid='0' class='current' id="sp"><span class='items' ><a href="{{url('IndexController/allshops')}}">全部商品</a></span></li>
                    @foreach($cate as $v)
                        @if($v->cate_id==$id)
                            <li sortid='100' reletype='1' linkaddr='' class="current aa" cateid="{{$v->cate_id}}" ><span class='items' >
                            <a href="{{url('IndexController/allshops')}}/{{$v->cate_id}}">{{$v->cate_name}}</a></span></li>
                        @else
                            <li sortid='100' reletype='1' linkaddr=''><span class='items' cateid="{{$v->cate_id}}" id="aa">
                            <a href="{{url('IndexController/allshops')}}/{{$v->cate_id}}">{{$v->cate_name}}</a></span></li>
                        @endif
                        @endforeach
                    ...
                    <div id="pullrefresh" class="good-list-box  mui-content mui-scroll-wrapper">
                        <div class="goodList mui-scroll">
                            <ul id="ulGoodsList" class="mui-table-view mui-table-view-chevron">
                                @foreach($arr as $v)
                                <input type="hidden" id="_toekn" value="{{csrf_token()}}">
                                <li id="23468">
                                    <span class="gList_l fl">
                                     <a href="{{url('IndexController/shopcontent')}}/{{$v['goods_id']}}"><img class="lazy" src="/uploads/{{$v['goods_img']}}"></a>
                                    </span>
                                    <div class="gList_r">
                                        ...
                                        <div class="gRate">
                                            ...
                                            <a codeid="12785750" class="add" goods_id="{{$v->goods_id}}" canbuy="646"><s></s></a>
                                        </div>
                                    </div>
                                </li>
                                    @endforeach
        ...
        <div class="footer clearfix">
            <ul>
                ...
                <li class="f_announced"><a href="{{url('IndexController/allshops')}}" class="hover"><i></i>全部商品</a></li>
